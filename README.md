...
•	View its HEX and RGB values instantly 
•	Copy the color codes for use in design or development
Expected Outcome:
•	A fully functional color picker website 
•	A responsive and clean user interface 
•	Real-time display of selected color codes (HEX, RGB, etc.) 
•	Interactive features such as copying color values
